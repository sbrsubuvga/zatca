String defaultUBLExtensions(
  ...
  return template
      .replaceAll('{SET_INVOICE_HASH}', invoiceHash)
      .replaceAll('{SET_SIGNED_PROPERTIES_HASH}', signedPropertiesHash)
      .replaceAll('{SET_DIGITAL_SIGNATURE}', digitalSignature)
      .replaceAll('{SET_CERTIFICATE}', certificateString)
      .replaceAll('{SET_SIGNED_PROPERTIES_XML}', signedPropertiesXml);
}
